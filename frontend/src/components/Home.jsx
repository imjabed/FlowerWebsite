    ...
    return(
        <>
            ...
            <div className={`h-screen w-full p-10 transition-all duration-300 ${gender === "her" ? "bg-pink-200 text-pink-600" : "bg-blue-200 text-blue-800"}`}>   
                <h2 className='text-[45px] text-center transition-all duration-300 mb-0 md:text-[60px] mb-4  ' style={{ fontFamily: '"Love Light", cursive' }}>Premium Collections</h2>
                <p className="text-[40px] text-center md:text-[40px] mb-4  transition-all duration-300" style={{ fontFamily: '"Love Light", cursive' }}>    
            ...
            <div className={`h-screen w-full p-10 transition-all duration-300 ${gender === "her" ? "bg-pink-100 text-pink-600" : "bg-blue-100 text-blue-800"}`}>
                <div > 
                  ...
                  <p  className="text-[40px] text-center md:text-[40px] mb-4  transition-all duration-300" style={{ fontFamily: '"Love Light", cursive' }}>{gender === "her" ? "For your queen" : "For your King"}</p>
                  <div className='flex flex-wrap justify-center gap-20'>
