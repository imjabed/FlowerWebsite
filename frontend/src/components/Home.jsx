          ...
          {/* <div className={`min-h-screen w-full px-4 py-8 sm:px-6 md:px-10 transition-all duration-300 ${gender === "her" ? "bg-pink-100 text-pink-600" : "bg-blue-100 text-blue-800"}`}>
            <div>
              ...
              <Swiper
                ...
                className="w-full"
              >
                {products.filter(p => p.productGender === gender && p.productCategory === "special").map(product => (
                  <SwiperSlide key={product._id}>
                    <div className={`${gender === 'her' ? "bg-pink-300" : "bg-blue-300"} rounded-xl shadow-lg p-4 w-[90%] max-w-[250px] mx-auto h-[380px] flex flex-col items-center justify-between`}>
                      ...
                      <p className="text-white text-center text-sm">{product.productDescription}</p>
                      <p className="text-white text-center font-bold mt-1">₹{product.productPrice}</p>
                      <button className={`${gender === 'her' ? "mt-2 px-4 py-1 bg-pink-500" : "mt-2 px-4 py-1 bg-blue-500"} text-white rounded-full hover:opacity-90 transition text-sm`}>
                        Shop Now
                      </button>
                    </div>
                  </SwiperSlide>
